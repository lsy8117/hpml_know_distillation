...
| SFT Student (Orig-Quant) | Qwen/Qwen2.5-3B-Instruct + qwen2.5-3B-Orig-Quant | 77.48 | 1022/1319 | 26.21 | 246.20 | `benchmark/gsm8k_benchmark_result/gsm8k_student_qwen2.5-3B-Orig-Quant_results.json` |
...
- SFT Student (Orig-Quant): Fine-tuned on original GSM8K data with NF4 quantization.
...
- Among the currently saved student checkpoints, `Orig-Orig` is the best overall student and is above the base model; `Orig-Quant`, `Distill-Orig`, and `Distill-Quant` are all below the base model on this benchmark.
